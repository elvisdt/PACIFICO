...
#define CONFIG_BROKER_URL "mqtt://161.97.102.234:1883"
...
/* check if mqtt is connected or no*/
bool mqtt_wifi_is_connected(){
    return MQTT_CONNEECTED;
}
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        // msg_id = esp_mqtt_client_publish(client, "OTA/INFO","{\"hola\":01}", 0, 1, 0);
