...
static int example_parse_nec_frame(rmt_symbol_word_t *rmt_nec_symbols, size_t symbol_num)
{
    ...
    */
    ...
    case 2: // NEC repeat frame
        if (nec_parse_frame_repeat(rmt_nec_symbols) && (symbol_num != last_symbol)) {
...
int init_ir_nec_task(){
    ...
    xTaskCreate(ir_nec_task, "Wdt_Task", 1024 * 4, NULL, 11, &xHandle);
