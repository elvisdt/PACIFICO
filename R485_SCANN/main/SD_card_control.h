...
#define FILE_NAME_DATA_UP   "dataUP.txt"

#define FILE_NAME_UP_DATA   "UPdata.txt"

#define FILE_NAME_UP_BOTONERA   "Botonera.txt"
...
esp_err_t sd_read_text_file(const char *filename);
