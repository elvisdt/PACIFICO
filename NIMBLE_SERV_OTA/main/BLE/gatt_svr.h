...
static const ble_uuid16_t gatt_svr_svc_ota_uuid = BLE_UUID16_INIT(0x2020);
 

// characteristic: OTA Control
static const ble_uuid16_t gatt_svr_chr_ota_control_uuid = BLE_UUID16_INIT(0xAA01);

// characteristic: OTA Data
static const ble_uuid16_t gatt_svr_chr_ota_data_uuid = BLE_UUID16_INIT(0xAA02);


static const ble_uuid16_t gatt_svr_chr_ctrl_nec_data_uuid = BLE_UUID16_INIT(0xAA03);
